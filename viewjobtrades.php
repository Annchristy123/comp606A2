  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item ">
          <a class="nav-link active" href="viewjobtrades.php"> View Jobs</a>
        </li>
        <li class="nav-item ">
      ...
      <tbody>
        <?php foreach ($jobs->getRecords() as $id => $job) {
          ...
          <tr>
            ...
            <td><?php echo "<a href=\"estimateForm.php?jid=" . $job->getJId() . "\"><button type=\"button\" class=\"btn btn-info\">Post Estimate</button></a>"; ?></td>
          </tr>
        <?php }; ?>
      </tbody>
    </table>
